...
function getAverageGoals(data) {
 ...
 let awayAverage = data.reduce((total, year) => {return total + year["Home Team Goals"]}, 0)/data.length; 
...
// let data = (fifaData.reduce((total, points) => total + points["Home Team Goals"]));
// console.log(data);
